    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('codice_destinatario_sdi', models.CharField(blank=True, help_text='Codice destinatario a 7 cifre per la ricezione fatture attive via SDI (o 0000000 se PEC)', max_length=7)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tenant', models.ForeignKey(blank=True, help_text='Nullo solo per gli amministratori della piattaforma', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='utenti', to='core.tenant')),
            ],
            options={
                'verbose_name': 'user',
